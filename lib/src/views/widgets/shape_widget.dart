...
class _ShapeWidgetState extends State<_ShapeWidget> {
      ...
      child: Stack(
        children: [
          ...
          GestureDetector(
            ...
            onTapDown: (TapDownDetails details) => initialStartPosition = details.localPosition,
            onScaleStart: onScaleStart,
            onScaleUpdate: onScaleUpdate,
            onScaleEnd: onScaleEnd,
            child: Container(
              color: Colors.transparent, // Color required to activate gesture detector
  ...
  Offset initialStartPosition = const Offset(0,0);
